  ...
  return (
    <div>
      <button
        ...
        className="flex items-center text-gray-600 hover:text-red-600 hover:scale-110"
      >
      ...
      {isModalOpen && (
        ...
        >
          <div
            className="bg-white p-6 rounded-lg w-11/12 max-w-md mx-auto relative"
          ...
          >
            ...
            <textarea
              ...
              className="w-full h-24 border p-2 mb-4 rounded"
